   ...
   if (Yvertical != 200){
    ...
    if (millis()-movingtime_start > 1000 && getballflag == 1){
       //finished initiate all para.
		 ...
		 back_to_center_distance = max (countL_ALL * distanceRatio, countR_ALL*distanceRatio);
